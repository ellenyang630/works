...
<div id="header">
    <div class="centerThis group">
        ...
        <div class="gnbWrap group">
            <ul class="gnb group">
                <li>
                    <a href="menu1_1.jsp">솔루션</a>
                    <ul>
                        <li>
                            <a href="menu1_1.jsp">대면결제</a>
                        </li>
                        <li>
                            <a href="menu1_2.jsp">부계정 서비스</a>
                        </li>
                        <li>
                            <a href="menu1_3.jsp">PG모듈</a>
                        </li>
                        <li>
                            <a href="menu1_4.jsp">주문서결제</a>
                        </li>
                        <li>
                            <a href="menu1_9.jsp">뱅크알람</a>
                        </li>
                        <li>
                            <a href="menu1_5.jsp">원격결제/해외결제</a>
                        </li>
                        <li>
                            <a href="menu1_6.jsp">QR결제</a>
                        </li>
                        <li>
                            <a href="menu1_7.jsp">통계툴</a>
                        </li>
                        <li>
                            <a href="menu1_10.jsp">메시징(문자/카톡)</a>
                        </li>
                        <li>
                            <a href="menu1_12.jsp">본인인증</a>
                        </li>
                        <li>
                            <a href="menu1_11.jsp">계좌실명인증</a>
                        </li>
                        <li>
                            <a href="menu1_8.jsp">가맹점관리/정산대행 </a>
                        </li>

                    </ul>
                </li>
                <li>
                    <a href="#"><label class="us">API</label>연동</a>
                    <ul>
                        <li>
                            <a href="#"><label class="us">API</label></a>
                        </li>
                        <li>
                            <a href="#">개발관련링크</a>
                        </li>
                        <li>
                            <a href="#"><label class="us">FAQ</label></a>
                        </li>
                        <li>
                            <a href="#"><label class="us">Q&A</label></a>
                        </li>
                        <li>
                            <a href="#">문의하기</a>
                        </li>
