                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-md">
                        <table class="table table-hover text-center">
                            <caption>결제내역 중 결제요청 건에 대한 내역</caption>
                            <thead class="thead-light">
                            <tr>
                                <th scope="col">NO</th>
                                <th scope="col">결제내역</th>
                                <%--<th scope="col">결제구분/결제자</th>--%>
                                        ...
                                        <dl class="list-data-text block-layout">
                                            <dt>
                                                <p class="inline-span-wrap">
                                                    <span>
                                                        <span class="badge badge-info-light">앱 요청</span>
                                                        <%--<span class="badge badge-info-light">웹 요청</span>--%>
                                                        <%--<span class="badge badge-info-light">엑셀 요청</span>--%>
                                                    </span>
                                                    <span>레일바이크 예약</span>
                                                </p>
                                            </dt>
                                    ...
                                    <div class="td-cell">
                                        <dl class="list-data-text inline-layout">
                                            ...
                                            <dd>
                                                <span>
                                                    <!-- 요청상태 -->
                                                    <span class="text-additional">결제요청</span> <br/>
                                                    <%--<span class="text-primary">결제완료</span> <br/>--%>
            ...
            <div class="card card-line">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-ct-bottom block">
                        ...
                        <a href="detail_statusReq.jsp" class="btn btn-lg btn-outline-primary rounded-sm">상세보기</a>
                    </div>
                </div>
                <!-- //card-body -->
            </div>
                ...
                <div class="card card-line">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="form-label" for="stateType">상태</label>
                            <select class="form-control custom-select" id="stateType">
                                <option selected>전체</option>
                                <option value="REQUEST">결제요청</option>
                                <option value="COMPLETE">결제완료</option>
                                <option value="FAIL">결제실패</option>
                                <option value="REQUEST_CANCEL">결제요청취소</option>
                                <option value="LIMIT">결제만료</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="reqType">요청방식</label>
                            <select class="form-control custom-select" id="reqType">
                                <option selected>전체</option>
                                <option value="MAIN_ID">웹</option>
                                <option value="SUB_ID">앱</option>
                                <option value="DELEGATE">엑셀-대량요청</option>
                            </select>
                        </div>
                        <div class="form-group">
