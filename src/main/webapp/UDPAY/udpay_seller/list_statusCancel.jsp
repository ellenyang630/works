                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-md">
                        <table class="table table-hover text-center">
                            <caption>결제내역 중 취소요청 건에 대한 내역</caption>
                            ...
                            <tr>
                                        ...
                                        <dl class="list-data-text block-layout">
                                            <dt>
                                                <p class="inline-span-wrap">
                                                    <span>
                                                        <%--<span class="badge badge-danger-light">결제취소완료</span>--%>
                                                        <span class="badge badge-additional-light">결제취소요청</span>
                                                        <%--<span class="badge badge-info-light">결제취소요청취소</span>--%>
                                                    </span>
                                                    <span>SMS 결제</span>
                                                </p>
                                            </dt>
                                ...
                                <td>
                                    <div class="td-cell">
                                        <dl class="list-data-text block-layout center">
                                            <dt>
                                                <span class="badge badge-primary-light">입금완료</span>
                                                <%--<span class="badge badge-info-light">입금대기</span>--%>
                                            </dt>
                                            <dd>
                                                <p><strong>971원</strong></p>
                                                <p>마동석</p>
            ...
            <div class="card card-line">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-ct-bottom block">
                        ...
                        <a href="detail_statusCancel.jsp" class="btn btn-lg btn-outline-primary rounded-sm">상세보기</a>
                    </div>
                </div>
                <!-- //card-body -->
            </div>
                ...
                <div class="card card-line">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="form-label" for="requestState">상태</label>
                            <select class="form-control custom-select" id="requestState">
                                <option selected>전체</option>
                                <option value="REQUEST">결제취소요청</option>
                                <option value="COMPLETE">결제취소완료</option>
                                <option value="CANCEL">결제취소요청취소</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-label">취소 요청일</div>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="payPhoneNum">결제 휴대폰번호</label>
                            <input type="text" class="form-control" id="payPhoneNum" placeholder="결제 휴대폰번호를 입력해주세요.">
                        </div>
                        <div class="form-group">
