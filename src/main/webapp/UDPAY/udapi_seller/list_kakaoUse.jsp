                                ...
                                <div class="help-text">
                                    <dl class="flex-line indiv">
                                        ...
                                        <dd>
                                            ...
                                            * 총 사용금액 : (성공건수 * 적용단가) + (실패 대체 발송 건 * 문자 적용단가) <br/>
                                            * 실제 발송을 기준으로 금액이 청구됩니다. <br/>
                                            * 문자대체발송여부가 체크된 경우, 알림톡 실패 건이 문자로 발송됩니다.
                                        </dd>
                                    </dl>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <div class="el-table__header-wrapper">
                                                <table class="el-table__header">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><div class="cell">문자대체발송 건수</div></th>
                                        ...
                                        <div class="el-table__empty-block">
                                            <div class="el-table__empty-text">
                                                ...
                                                <p class="empty__info-text">알림톡 사용현황 내역이 없습니다.</p>
                                            </div>
                                        </div>
