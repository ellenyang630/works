        ...
        <div class="utilBox right">
          ...
          <ul class="topMenu">
            ...
            <li class="alarm active">
              <a onclick="window.open('list_alarm.jsp', '_self')"><i class="la la-bell-o"></i><span class="invisible">알림내역</span></a>
            </li>
            <li class="mypage">
              <a onclick="window.open('set_mypage.jsp', '_self')"><i class="la la-cog"></i><span class="invisible">마이페이지</span></a>
            </li>
            <li class="logout">
              <a onclick="window.open('login.jsp', '_self')"><i class="la la-sign-out"></i><span class="invisible">로그아웃</span></a>
            </li>
          </ul>
        </div>
        <!-- //utilBox.right -->
