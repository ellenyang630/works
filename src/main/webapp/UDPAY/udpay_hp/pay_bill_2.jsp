...
<div class="subBigTab">
    <div class="centerThis">
        <ul class="garoTBCell col_2">
            <li>
                <a href="pay_bill.jsp">정기 결제</a>
            </li>
            <li>
                <a href="pay_bill_2.jsp" class="active">등록 결제</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <section class="ssc">
        <div class="centerThis">
            <div class="ttBoxCenter first">
                ...
                <h3>
                    빌링결제는 고객의 결제정보를 암호화된 인증키로 저장한 뒤 결제요청 시 자동으로 결제되게 하는 서비스입니다.
                    <br> 빌링결제는 결제주기에
            ...
            <div class="billBan">
                <div class="textBox">
                    <h2><strong>단, 한번 등록</strong>으로 간편하게 결제해 보세요!</h2>
                    <h3>결제등록 한번으로, 다음 번 반복해서 일어나는 결제들은 바로 바로 확인만 하면 결제 끝!
                    </h3>
                </div>
            </div>
            <div class="ttBox">
                ...
                <ul class="garoCell col_3">
                    <li>
                        <dl>
                            <dt>1</dt>
                            <dd>
                                결제 편의성 : 최초 빌링결제 신청으로 매월 고객이 직접 결제하는 수고를 덜 수 있습니다.
                            </dd>
                        </dl>
                    </li>
                    <li>
                        <dl>
                            <dt>2</dt>
                            <dd>
                                수납률 상승 : 신용카드 결제를 통해 기존 CMS 자동이체 서비스보다 수납률을 제고할 수 있습니다.
                            </dd>
                        </dl>
                    </li>
                    <li>
                ...
                <ul class="garoCell col_3">
                    <li>
                        <dl>
                            <dt>4</dt>
                            <dd>
                                관리비용 절감 : 번거로운 수금 업무를 유디페이 빌링결제로 대체함으로써 관리비용을 절감할 수 있습니다.
                            </dd>
                        </dl>
                    </li>
                    <li>
        ...
        <div class="centerThis">
            ...
            <div class="stepImgBox garoCell col_2">
                <ul>
                    <li>
                        <div class="imgBox">
                            <img src="images/step/bill_pc_2_1.jpg">
                        </div>
                        <dl>
                            <dt>STEP 1</dt>
                            <dd>결제요청 <i class="xi2-angle-right-min"></i> 등록결제 <i class="xi2-angle-right-min"></i> 등록요청</dd>
                        </dl>
                    </li>
                    <li>
                        <div class="imgBox">
                            <img src="images/step/bill_pc_2_2.jpg">
                        </div>
                        <dl>
                            <dt>STEP 2</dt>
                            <dd>결제 정보 입력 후 등록</dd>
