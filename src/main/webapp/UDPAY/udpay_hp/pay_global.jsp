            ...
            <div class="snb-inner-wrap group">
                <div class="snb-inner-box">
                    ...
                    <div class="snb-depth snb-depth02">
                        <a href="pay.jsp" class="current-snb">해외카드결제</a>
                        <ul id="snb02">
    ...
    <section class="ssc">
        <div class="centerThis">
            <div class="ttBoxCenter first">
                <h2>해외카드 결제 서비스란?</h2>
                <h3>
                    해외카드결제는 해외발행카드(VISA, MASTER CARD, JCB)를 통해 국내 가맹점에서 자국의 화폐로 결제할 수 있는 신용카드 결제 서비스 입니다.
                </h3>
            </div>
            <div class="ttBox">
                <h2>해외카드결제 특장점</h2>
            ...
            <div class="pointBox">
                <ul class="garoTBCell">
                    <li>
                        <dl>
                            <dt>POINT <label>VISA3D 인증을 통해 온라인 결제</label></dt>
                            <dd>VISA3D 인증이란, VISA카드에서 개발된 인증 서비스로 사전 등록된 비밀번호를 입력하여 인증하는 방식 입니다.
                            </dd>
                        </dl>
                    </li>
                </ul>
