                    ...
                    <ul class="joinInput">
                        <li>
                            <dl>
                                <dt>사업자 구분 <em>*</em></dt>
                                <dd>
                                    <div class="textSel radioSel">
                                        <span class="input_chk">
                                            <input type="radio" id="corp" name="check">
                                            <label for="corp">법인</label>
                                        </span>
                                        <span class="input_chk">
                                            <input type="radio" id="pers" name="check">
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    <div class="textSel">
                                        <span><select name="" id="">
                                            <option value="">업태를 선택해 주세요.</option>
                                        </select></span>
                                        <span><select name="" id=""><option
                                                value="">업종을 선택해 주세요.</option></select></span>
                                    </div>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            <dl>
                                <dt>대표자명 <em>*</em></dt>
                                <dd>
                                    <input type="text" class="int" placeholder="대표자명을 입력해 주세요.">
                                </dd>
                            </dl>
                        </li>
                        <li>
