...
<div class="title_box clearfix">
	...
	<div class="location">
		<ul class="clearfix">
			...
			<li class="bdln">
				<strong class="active">결제취소요청</strong>
			</li>
		</ul>
	</div>
	<!--//.location-->
...
<div class="cardWrap list">
	<div class="cardInner">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="formEleWrap">
						<label class="label_tit" for="slct">입금상태</label>
						<div class="selectBox">
		...
		<div class="tbHead">
			<div class="clearfix">
				...
				<div class="pull-right listContBtn">
					<p class="alert_text2">
						<strong>입금은행 : 신한은행 / 입금계좌 : 140-012-559222 / 예금주 : ㈜쏘다</strong>
					</p>
		...
		<div class="table-responsive">
			<table class="tbList">
                <caption class="sr_only">결제취소요청 리스트</caption>
				<colgroup>
					<col width="55">
                    <col width="*">
					<col width="10%">
					...
					<tr class="height_lg">
						...
						<td>
							<div class="multiTd block">
								...
								<div class="multiTd_Li">
									<div class="multiTd_LiDt">취소요청일시</div>
									<div class="multiTd_LiDd">2019-03-28 11:11:11</div>
								</div>
							</div>
							<!--// multiTd.block -->
						...
						<td>
							<div class="multiTd md">
								<div class="multiTd_Li">
									<div class="multiTd_LiDt">입금상태</div>
									<div class="multiTd_LiDd">입금대기</div>
								</div>
								<div class="multiTd_Li">
									<div class="multiTd_LiDt">입금금액</div>
									<div class="multiTd_LiDd">
										<strong>140,000</strong> 원
									</div>
								</div>
								<div class="multiTd_Li">
									<div class="multiTd_LiDt">입금자명</div>
									<div class="multiTd_LiDd">홍길동</div>
								</div>
							</div>
							<!--// multiTd -->
						</td>
                        <td>
                            <div class="tdBtnWrap">
                                <a href="payCaView.jsp" class="btn btn-xs">상세</a>
		...
		<div class="alert_text red">
			...
			취소처리 완료된 데이터는 결제완료/취소 리스트에서 확인 가능합니다.
		</div>
