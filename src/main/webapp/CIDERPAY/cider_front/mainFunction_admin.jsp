                    ...
                    <div class="subPage-inner">
                        <div class="subPage-section">
                            <div class="subPage-section-header center">
                                <h4 class="subPage-section-title with-icon"><strong>결제 현황과 정산 관리를 한눈에</strong></h4>
                                <p class="subPage-section-desc">
                                    쉽고 간편한 관리자 웹 페이지를 제공해 드립니다.
                                </p>
                                <p class="subPage-section-deviceSt mt">
                                    <span class="line-box-effect">관리자 PC 화면</span>
                                </p>
                            </div>
                            <div class="subPage-section-body">
                                <div class="guide desktop">
                                    <div class="guide-img">
                                        <img src="assets/img/sub/guide/img_admin_pc1.png" alt="">
                                    </div>
                                </div>
                                    ...
                                    <li class="flow-item">
                                        <div class="flow-item-container">
                                            ...
                                            <p class="flow-item-desc">
                                                직관적인 UI를 통해 일자 별, 월 별 결제 금액 및<br/>
                                                정산 금액 조회가 가능합니다
                                            </p>
                                        </div>
                                    </li>
