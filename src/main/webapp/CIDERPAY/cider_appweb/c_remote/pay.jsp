				...
				<div class="viewBox writeInfo">
					<div class="formWrap">
						<form name="" action="" method="post">
							...
							<div class="intGroup">
								<label class="wrapLabel" for="dateOfBirth"><span class="inputName">본인확인</span></label>
								<input type="number" id="dateOfBirth" class="dateOfBirth" placeholder="생년월일 6자리">
							</div>

							<div class="intGroup">
								<label class="wrapLabel" for="cardPass"><span class="inputName">카드 비밀번호</span></label>
								<div class="inputWrap col_3 clearfix">
									<input type="password" id="cardPass" name="cardPass" placeholder="앞 2자리" maxlength="2">
									<p class="input_subtext">●●</p>
								</div>
							</div>
							...
							<div class="intGroup">
								...
								<div class="groupSlt">
									<select class="selectBox" id="interestSlt" name="interestSlt" disabled >
										<option>일시불(5만원 이상 가능)</option>
										<option>일시불(5만원 이상 가능)</option>
									</select>
								</div>
							</div>
