			...
			<div class="viewBox writeInfo">
				<div class="formWrap">
					<form name="" action="" method="post">
						...
						<div class="intGroup">
							<label class="wrapLabel" for=""><span class="inputName">휴대전화</span></label>
							<input type="tel" placeholder="휴대전화번호를 입력해주세요." value="010-1234-5678">
						</div>
						<div class="intGroup">
							<p><span class="inputName alone">과세/면세</span></p>
							<span class="input_chk first">
								<input type="radio" id="aa" name="aa" checked>
								<label class="wrapLabel" for="aa"><span class="inputName">과세</span></label>
							</span>
							<span class="input_chk">
								<input type="radio" id="bb" name="aa">
