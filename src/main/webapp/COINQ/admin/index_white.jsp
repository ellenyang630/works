...
<html lang="ko">
	<head>
		...
		<style>
			...
			#cssmenu .has-sub.active > a, #cssmenu .has-sub2 > a:hover, #cssmenu .has-sub.active_important > a span:after, #cssmenu .has-sub.active_important.active > a span:after {
				color: #2e2e2e;
			}
			#cssmenu > ul > li.active_important > a, #cssmenu > ul > li > a {
				color: #2e2e2e;
			}
			#ltnav {
				background: #fff;
			...
			#cssmenu > ul > li.has-sub.active > a, #cssmenu > ul > li > ul {
				background: #f5f7f8;
			}
			...
			#cssmenu > ul > li.has-sub.active >a i, 	#cssmenu > ul > li.has-sub.active >a span:before, #cssmenu > ul > li.has-sub.active >a span:after{
	...
	<body>
		...
		<div id="content_wrap" class="clearfix">
			<div id="ltnav">
				<div class="logoBox">
					<a href="#"><img src="images/logo.png" alt="코인큐"></a>
				</div>
				<div id="cssmenu">
					<ul>
						<li>
