					...
					<table class="tbSimple2 td_tr">
						...
						<tbody>
							<tr>
								<th>거래 구분</th>
								<td>
									<img src="images/coin/icon_btc.png" alt=""  width="20" height="20" class="coinThumb">
									비트코인 
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th><p>적용 시세</p><h4 class="mgt5">빗썸</h4></th>
						...
						<tbody>
							...
							<tr>
								...
								<div class="sliderBox">
									<div class="rangeWrap">
										<div class="rangeText">
											BTC <span><input type="text" value="0.18345" class="rangeInt"></span>
											<div class="inBlock">
