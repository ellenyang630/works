		...
		<div class="inner">
			<div class="centerThis">
				<div class="joinBizCont">
					...
					<div class="termsWrap">
						<div class="terms">
							<p class="termsTit"><span class="cred">[필수]</span> 판매회원 이용약관</p>
							<div class="termsCont">
						...
						<div class="terms">
							<p class="termsTit"><span class="cred">[필수]</span> 판매회원 개인정보수집 및 이용약관</p>
							<div class="termsCont">
								Lorem ipsum dolor sit amet, consetetur sadipscing elitr,  sed diam nonumy eirmod tempor invidunt ut labore et dolore magna 
								aliquyam erat, sed diam voluptua.<br/>
								At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum 
					...
					<div class="cardBtnWrap">
						<div class="row">
							<div class="col-xs-12 col-md-4 col-md-offset-4">
								<a href="join_biz3.jsp" class="btn btn-md bmainblue">동의하고 회원가입</a>
							</div>
							<!-- <div class="col-xs-6 col-md-3">
								<a href="join_biz3.jsp" class="btn btn-md bgreen">사업자 판매회원</a>
							</div> -->
						</div>
					</div><!--//cardBtnWrap-->
				</div>
