...
<div class="title_box clearfix">
	...
	<div class="location">
		<ul class="clearfix">
			...
			<li class="bdln">
				<strong class="active">부 계정 판매현황</strong>
			</li>
		</ul>
	</div>
	<!--//.location-->
		...
		<div class="table-responsive">
			<table class="table tbList tb-line">
				...
				<tr class="nrTh" colspan="2">
					<th rowspan="2">NO</th>
					<th rowspan="2"><span class="hand">조직정보 <i class="fa fa-caret-down pdl10" aria-hidden="true"></i></span></th>
					<th rowspan="2">사용자명</th>
					<th rowspan="2">휴대전화</th>
					<th rowspan="2">직급</th>
					<th colspan="2">어제</th>
					<th colspan="2">오늘</th>
					<th colspan="2">기간 별</th>
				...
				<tr class="nrTh">
					...
					<th scope="col">금액</th>
					<th scope="col">건수</th>
					<th scope="col" class="borderR">금액</th>
				</tr>
				</thead>
				<tbody>
				<tr>
					...
					<td>0</td>
					<td>
						<span><a class="btn btn-sm lmainblue col-xs-12">결제현황</a></span>
					</td>
				</tr>
				<tr>
					<td>2</td>
