...
<div class="title_box clearfix">
	...
	<div class="location">
		<ul class="clearfix">
			...
			<li class="bdln">
				<strong class="active">결제내역</strong>
			</li>
		</ul>
	</div>
	<!--//.location-->
			...
			<table class="table tbList tb-line">
				...
				<tbody>
					...
					<tr>
						...
						<td><!-- <span><a href="#" class="btn btn-sm lmainblue col-xs-12" data-toggle="modal" data-target="#rerepeat">링크 재 전송</a></span>
						<span><a href="#" class="btn btn-sm lmainblue col-xs-12 mgt10">결제요청취소</a></span> --></td>
					</tr>
					<tr>
						<td>연동결제</td>
						<td class="text-left">
