							...
							<tr>
								...
								<div class="clearfix mgt10">
									<div class="pull-right">
										<strong class="number">13,442,000</strong><small>KRW</small>
									</div>
								</div></td>
								<td class="pd20">
								<div class="clearfix">
			...
			<table class="table tbList tb-line">
				...
				<tbody>
					...
					<tr>
						...
						<div class="cellgroup mblock">
							<div class="cell text-left">
								<a class="cmainblue" href="payList_coinq_view.jsp">LG전자 14ZD980-GX50K</a>
							</div>
						...
						<td><!-- <span><a href="#" class="btn btn-sm lmainblue col-xs-12">링크취소</a></span> --><span><a href="#" class="btn btn-sm lblack col-xs-12" data-toggle="modal" data-target="#rerepeat">링크 재 전송</a></span><span><a href="#" class="btn btn-sm lblack col-xs-12 mgt10">결제요청취소</a></span></td>
					</tr>
					...
					<tr>
						...
						<td><p class="smbox  bpurple">결제완료</p></td>
						<td>
						...
						<div class="cellgroup mblock">
							<div class="cell text-left">
								<a class="cmainblue" href="payList_card_view.jsp">LG전자 14ZD980-GX50K</a>
							</div>
							<div class="cell text-right mtl">
								<strong class="number">1,248,000</strong> <small>KRW</small>
							</div>
						...
						<div class="clearfix">
							<div class="pull-left mclearfix mtl">
						...
						<td><a href="#" data-toggle="modal" data-target="#talkPop"><span class="mainIncon on"><i class="fa fa-envelope-o" aria-hidden="true"></i> <em class="alertNumMail"> 18 </em></span></a></td>
						<td><span><a href="#" class="btn btn-sm lblack col-xs-12"   data-toggle="modal" data-target="#payCancel">결제취소</a></span><span><a href="#" class="btn btn-sm lblack col-xs-12 mgt10">영수증보기</a></span></td>
					</tr>
					...
					<tr>
						...
						<div class="cellgroup mblock">
							<div class="cell text-left">
								<a class="cmainblue" href="payList_phone_view.jsp">LG전자 14ZD980-GX50K</a>
							</div>
							<div class="cell text-right mtl">
								<strong class="number">1,248,000</strong> <small>KRW</small>
							</div>
					...
					<tr>
						...
						<div class="cellgroup mblock">
							<div class="cell text-left">
								<a class="cmainblue" href="payList_multi_view.jsp">LG전자 14ZD980-GX50K</a>
							</div>
							<div class="cell text-right mtl">
								<strong class="number">1,248,000</strong> <small>KRW</small>
							</div>
						...
						<td><span><a href="#" class="btn btn-sm lblack col-xs-12">결제취소요청</a></span></td>
					</tr>
