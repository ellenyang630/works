				...
				<tr>
					...
					<td>
						<div id="bo_v_con">
							...
							송금을 하려고 하는 데 자꾸 실패하네요.<br><br>
							연락주세요.<br>
							안녕하세요.<br>
							문의사항이 있어서 문의드립니다.<br>

							송금을 하려고 하는 데 자꾸 실패하네요.
							연락주세요.<br>
							안녕하세요.
							문의사항이 있어서 문의드립니다.
			...
			<%--<div id="bo_v" class="row">
				...
				<%--<div id="bo_v_btn">
					...
					<ul class="bo_v_com clearfix mgt15">
						<li class="pull-left mgr10"><a href="#" class="btn lmainblue">수정</a></li>
						<li class="pull-left"><a href="#" class="btn lgray">삭제</a></li>
				...
				<div id="bo_v_btn">
					...
					<div class="btn_save_wrap group">
						<div class="pull-left">
							<span><a class="btn lmainblue">수정</a></span>
							<span><a class="btn lgray mgl10">삭제</a></span>
						</div>
