						...
						<div class="col-xs-12 col-md-6">
							...
							<table class="tbSimple2 tbnoLine">
								...
								<tbody>
									...
									<tr>
										<th class="vertical-top">통신판매업신고</th>
										<td>
											<div>
									...
									<tr class="intTr">
										<th class="vertical-top">사업장 주소</th>
										<td>
											<div class="clearfix">
						...
						<div class="col-xs-12">
							...
							<table class="tbSimple2 tbnoLine">
								...
								<tbody class="mInblock">
									...
									<tr class="intTr">
										<th class="vertical-top">판매회원 등록 계약서<small>(간이과세자 제외)</small></th>
										<td>
											<ul class="docBox">
									...
									<tr class="intTr">
										<th>추가서류</th>
										<td>
											<label class="btn lmainblue attachFile">파일첨부
												<input type="file" class="fileUp">
								           </label>
