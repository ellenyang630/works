                ...
                <div class="card-body">
                    <div class="table-list-head">
                        ...
                        <div class="btn-ct-top">
                            <a href="form_qna.jsp" class="btn btn-sm btn-outline-primary btn-ico-hover"><i class="xi-pen-o"></i> 문의하기</a>
                        </div>
                    </div>
                    <!-- //table-list-head -->
                    <div class="table-responsive-md">
                        <table class="table table-hover text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-cell">
                                        <span class="badge badge-info-light">미답변</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="td-cell">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-cell">
                                        <span class="badge badge-primary-light">답변완료</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="td-cell">
